<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlertFollewup.aspx.cs" Inherits="AlertFollewup" %>
...
<td width =120>批次<asp:DropDownList ID="ddlPatch" runat="server" Height =19px Width =85px  > </asp:DropDownList></td>
      ...
      <td width =320>跟进日期<asp:TextBox ID="txtDateFrom" runat="server" Width =100></asp:TextBox><img src="Images/Calendar.gif"  style=" cursor:hand "  onclick ="ShowCalenderWindow('txtDateFrom')"/>到<asp:TextBox ID="txtDateTo" runat="server" Width =100></asp:TextBox><img src="Images/Calendar.gif"  style=" cursor:hand "  onclick ="ShowCalenderWindow('txtDateTo')"/></td>
      <td align =left>
...
<asp:BoundField DataField="Date1" HeaderText ="跟进日期"  ItemStyle-Width=80/>
