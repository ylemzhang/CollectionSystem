...
//function displayMenu(fo_id){
//    if($('#menuGroup'+fo_id).attr('class') == "selected"){ 
//        $('#menuGroup'+fo_id).attr("class","");
//        $('#groupimg'+fo_id).attr("src","images/t_list_09.jpg");
//        $("li[@pid=" + fo_id + "]").hide();
//    }else{ 
//        $('#menuGroup'+fo_id).attr("class","selected");
//        $('#groupimg'+fo_id).attr("src","images/t_list_10.jpg");
//        $("li[@pid=" + fo_id + "]").show();
//    }
//    
//}
