...
function  ConfirmDelete()
     ...
     function add()
    {
      window.location.href ="UserEdit.aspx?id=";
    }
...
<body >
    ...
    <tr bgcolor=#F7F7F7><td><strong>用户管理 </strong></td><td align =right valign =top class="menu" ><span  style ="cursor:hand; color:blue" onclick="add()" >
