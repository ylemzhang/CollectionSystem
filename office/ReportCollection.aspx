<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportCollection.aspx.cs" Inherits="ReportCollection" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>催收人员电话/出访统计表</title>
...
<body>
    ...
    <table width =600   bgColor="#F7F7F7" border =1  align =center  >
     <tr>
     <td style='border-style:outset ; border-width:1px;'><table width=100%><tr> 
    
    <td  align =center valign =middle><h2>催收人员电话/出访统计表</h2></td></tr></table></td>
    ...
    <td>
      <table>
         ...
         <tr>
   <td>公司:<asp:DropDownList ID="ddlCompany" runat="server" >
      </asp:DropDownList></td>
