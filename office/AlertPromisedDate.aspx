<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlertPromisedDate.aspx.cs" Inherits="AlertPromisedDate" %>
...
<td width =120>批次<asp:DropDownList ID="ddlPatch" runat="server" Height =19px Width =85px  > </asp:DropDownList></td>
  ...
  <td width =200>承诺金额<asp:TextBox ID="txtFrom" runat="server" Width =40 Height =15px></asp:TextBox>到<asp:TextBox ID="txtTo" Width =40 runat="server" Height =15px></asp:TextBox>
      </td>
      <td width =320>承诺日期<asp:TextBox ID="txtDateFrom" runat="server" Width =100></asp:TextBox><img src="Images/Calendar.gif"  style=" cursor:hand "  onclick ="ShowCalenderWindow('txtDateFrom')"/>到<asp:TextBox ID="txtDateTo" runat="server" Width =100></asp:TextBox><img src="Images/Calendar.gif"  style=" cursor:hand "  onclick ="ShowCalenderWindow('txtDateTo')"/></td>
      <td align =left>
...
<asp:BoundField DataField="Date1" HeaderText ="承诺还款日期"  ItemStyle-Width=80/>
<asp:BoundField DataField="Num1" HeaderText ="承诺还款金额"  ItemStyle-Width=80/>
